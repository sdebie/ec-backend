...
class ProductServiceTest
{
    ...
    void getProductInformationDto_shouldMapNestedProductWithVariantsAndImages()
    {
        ...
        when(productVariantRepository.findNonDisabledVariantsForProductId(productId)).thenReturn(variants);
        ...
        verify(productVariantRepository).findNonDisabledVariantsForProductId(productId);
